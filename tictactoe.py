...
import random  #for function IA random play 
end_game = False
row1_list = [' ', ' ', ' ']
row2_list = [' ', ' ', ' ']
row3_list = [' ', ' ', ' ']
...
#Problem! if IA runs 2 plays and the space is filled on both,it stops running the function random_play() to get more plays
...
def verify_winner():
    ...
    #diagonal win /
        ...
        if row1_list[0] == 'X':
            ...
            print('You lost the game! Enemy Diagonal win')
    #draw    
    # DONT KNOW HOW TO DO, THIS CONDITIONAL AWAYS HIT, PRINT DRAW FOR ALL PLAYS.

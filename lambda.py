...
#AVERAGES = CRIACAO DE LISTA( COM MAP( LAMBDA NUMLIST : FUNCAO NUMLIST, A LISTA DE NUMEROS PRA ITERAR))
...
#crio a lista( e uso filter(recebe funcao lambda x: len(x) < 10, lista iteravel cities))
# solucao udacity
print(short_cities)